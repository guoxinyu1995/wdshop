 ...
 * 待付款字条目的Adaper
 * */
public class OrderObligationItemAdaper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<OrderBean.OrderListBean.DetailListBean> mData;
    private Context mContext;

    public OrderObligationItemAdaper(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.order_obligation_child_item, viewGroup, false);
